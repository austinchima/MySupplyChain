...
namespace MySupplyChain.Infrastructure.Migrations
{
    ...
    [Migration("20260619043431_AddRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MySupplyChain.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<int?>("ActualLeadTimeDays")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MySupplyChain.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MySupplyChain.Domain.Entities.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("PromisedLeadTimeDays")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MySupplyChain.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a3b9a29a-da67-4c94-aaa4-e377c0464940",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "58ebc16f-1118-4bf0-b5bf-55b747ea155a",
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("MySupplyChain.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("MySupplyChain.Domain.Entities.Supplier", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MySupplyChain.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("MySupplyChain.Domain.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MySupplyChain.Domain.Entities.ReorderRequest", b =>
                {
                    ...
                    b.HasOne("MySupplyChain.Domain.Entities.Supplier", "Supplier")
                        .WithMany("ReorderRequests")
                        .HasForeignKey("SupplierId")
                        .OnDelete(DeleteBehavior.SetNull);
