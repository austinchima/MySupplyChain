...
interface LoginGateProps {
  ...
  setShowTroubleshoot: (v: boolean) => void;
  handleManualLogin: (e: React.FormEvent) => void;
  handleQuickConnect: (role: "admin" | "user") => void;
}
...
function LoginGate({
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-margin-mobile">
      <div className="w-[400px] max-w-[90%] bg-surface-container border border-outline-variant/30 rounded-2xl p-8 space-y-lg shadow-2xl backdrop-blur-md">
...
function App() {
  ...
  if (loading) {
    return (
      <div className="w-full min-h-screen bg-background flex flex-col items-center justify-center p-margin-mobile">
        <div className="w-[400px] max-w-[90%] bg-surface-container border border-outline-variant/30 rounded-2xl p-8 text-center space-y-lg shadow-2xl backdrop-blur-md">
